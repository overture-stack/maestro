...
class ManagementControllerTest extends MaestroIntegrationTest {
    ...
    @Test
    void indexStudy_shouldExcludeAnalysisByStudyId() throws InterruptedException {
        // Given
        val analyses = loadJsonFixture(this.getClass(), "PEME-CA.study.json",
        ...
        assertNotNull(docs);
        assertEquals(0L, page.getContent().size());
    }
    ...
    void indexStudyRepository() throws InterruptedException {
        ...
        val expectedDocs = Arrays.asList(loadJsonFixture(this.getClass(),
            "docs.json", FileCentricDocument[].class, elasticSearchJsonMapper));
    ...
    @Test
    void indexStudyRepository_shouldExcludeByStudyId() throws InterruptedException {
        // Given
        ...
        for (Study study: studies) {
            ...
            val command = GetStudyAnalysesCommand.builder()
                .filesRepositoryBaseUrl(applicationProperties.repositories().get(0).getUrl())
                .studyId(studyId)
                .build();
            val studyAnalyses = getStudyAnalyses(studyId);
        }
