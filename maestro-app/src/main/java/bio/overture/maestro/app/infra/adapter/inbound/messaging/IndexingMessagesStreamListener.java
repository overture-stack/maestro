...
public class IndexingMessagesStreamListener {
    ...
    @StreamListener
    public void handleRemoveAnalysisMessage(@Input(Sink.INPUT) Flux<RemoveAnalysisFilesMessage> removeAnalysisFilesMessageFlux) {
        removeAnalysisFilesMessageFlux.subscribe( msg -> {
            try {
                indexer.removeAnalysis(RemoveAnalysisCommand.builder()
