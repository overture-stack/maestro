...
export default function suite() {
	...
	it('should return successful true when bulk upserting data', async () => {
		...
		const bulkRequest: UpsertBulkRequest[] = records.map((data) => ({ action: BulkAction.UPSERT, dataSet: data }));
